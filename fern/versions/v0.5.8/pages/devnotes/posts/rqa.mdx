...
<MetricsTable
  headers={["Data Blend", "Val Loss (↓)", "MMLU-Pro CoT (↑)", "Math 500 CoT (↑)", "GSM8K CoT (↑)", "Humaneval+ (↑)", "MBPP+ (↑)"]}
  rows={[["Baseline data blend (140k steps)", 1.309, 36.99, "—", 79.98, 38.14, 48.68], ["Baseline data blend (158k steps)", 1.258, 43.39, 71.0, 81.96, 42.71, 53.31], ["with RQA (4.5m @4%, 158k steps)", 1.256, 44.31, 73.4, 82.79, 47.2, 54.84], ["with RQA (9m @8%, 158k steps)", 1.255, 45.8, 73.4, 84.76, 45.61, 53.8]]}
  lowerIsBetter={[1]}
/>
