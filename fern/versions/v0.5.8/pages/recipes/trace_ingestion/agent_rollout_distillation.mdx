...
<Info title="Download Recipe">
  [Download the complete recipe script](https://github.com/NVIDIA-NeMo/DataDesigner/blob/main/docs/assets/recipes/trace_ingestion/agent_rollout_distillation.py)
</Info>
