...
<Info title="Download Recipe">
  [Download the complete recipe script](https://github.com/NVIDIA-NeMo/DataDesigner/blob/main/docs/assets/recipes/vlm_long_doc/01-seed-dataset-preparation.py)
</Info>
